        ...
        <Layout style={{ minHeight: '100vh' }}>
            ...
            >
                <Title level={2} style={{ color: 'white', margin: '0 0 8px 0' }}>
                    ⚛️ React Ant Design Sample Tool
                </Title>
                <Paragraph style={{ color: 'white', fontSize: '14px', margin: '0 0 12px 0' }}>
                    A complete example of building Power Platform Tool Box tools with React & TypeScript based on Ant Design components.
                </Paragraph>
                <Space
                    wrap
                    size="small"
            ...
            >
                <ConnectionStatus connection={connection} isLoading={isLoading} onLog={addLog} />
