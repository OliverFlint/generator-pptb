...
import { CheckCircleOutlined, InfoCircleOutlined, WarningOutlined, CloseCircleOutlined, CopyOutlined, BgColorsOutlined, SaveOutlined } from '@ant-design/icons';
            ...
            <Space direction="vertical" size="large" style={{ width: '100%' }}>
                <div>
                    ...
                    <Space wrap>
                        ...
                        <Button icon={<InfoCircleOutlined />} onClick={() => showNotification('Information', 'This is an informational message', 'info')}>
                            Show Info
                        </Button>
                        <Button icon={<WarningOutlined />} onClick={() => showNotification('Warning', 'Please review this warning', 'warning')}>
                            Show Warning
                        </Button>
                        <Button danger icon={<CloseCircleOutlined />} onClick={() => showNotification('Error', 'An error has occurred', 'error')}>
                            Show Error
                        </Button>
                    </Space>
                </div>
