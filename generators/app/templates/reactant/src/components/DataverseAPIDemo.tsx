        ...
        <Card title="💾 Dataverse API Examples" style={{ marginBottom: 24 }}>
            <Space direction="vertical" size="large" style={{ width: '100%' }}>
                <div>
                    ...
                    <Button type="primary" icon={<SearchOutlined />} onClick={queryAccounts} style={{ marginBottom: 8 }}>
                ...
                <div>
                    ...
                    <Space direction="vertical" style={{ width: '100%' }}>
                        ...
                        />
                        <Space wrap>
                            <Button type="primary" icon={<PlusOutlined />} onClick={createAccount}>
                                Create Account
                            </Button>
                            <Button icon={<EditOutlined />} onClick={updateAccount} disabled={!createdAccountId}>
                                Update Account
                            </Button>
                            <Button danger icon={<DeleteOutlined />} onClick={deleteAccount} disabled={!createdAccountId}>
                                Delete Account
                            </Button>
                        </Space>
                        <TextArea
                ...
                <div>
                    ...
                    <Button icon={<InfoCircleOutlined />} onClick={getAccountMetadata} style={{ marginBottom: 8 }}>
