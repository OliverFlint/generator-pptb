...
function App() {
    ...
    return (
        <ThemeProvider theme={theme}>
            <CssBaseline />
            <Box sx={{ bgcolor: 'background.default', minHeight: '100vh', p: '10px' }}>
                <Box sx={{ width: 'calc(100% - 10px)', mx: 'auto' }}>
                    <Box sx={{ mb: 4, textAlign: 'center' }}>
                        ...
                        <Typography variant="subtitle1" color="text.secondary">
                            A complete example of building Power Platform Tool Box tools with React & TypeScript based on Material UI
                        </Typography>
                    </Box>
