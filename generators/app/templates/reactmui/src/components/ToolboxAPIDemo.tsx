        ...
        >
            <CardContent sx={{ flex: 1 }}>
                ...
                <Box>
                    ...
                    <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap>
                        <Button variant="outlined" startIcon={<ContentCopyIcon />} onClick={copyToClipboard}>
                            Copy to Clipboard
                        </Button>
                        <Button variant="outlined" startIcon={<PaletteIcon />} onClick={showCurrentTheme}>
                            Get Theme
                        </Button>
                        <Button variant="outlined" startIcon={<SaveIcon />} onClick={saveDataToFile}>
                            Save File
                        </Button>
                    </Stack>
                </Box>
